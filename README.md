...
If this saved you from `ERR_REQUIRE_ESM`, [star the repo](https://github.com/ofershap/tiny-escape) or [open an issue](https://github.com/ofershap/tiny-escape/issues) if something breaks.
